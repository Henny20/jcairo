...
public final class CairoContext {
	...
	public void setSource(Color c) {
		setSourceRGB(c.red, c.green, c.blue);
	}
     ...
     //   public void setLineCap(LineCap lc) {
            //     setLineCap(lc.ordinal());
      // } 
	...
	public native void setSourceRGB(double red, double green, double blue);

	public native void setSourceRGBA(double red, double green, double blue, double alpha);

	public native void setSource(CairoPattern source);

        public native void setSourceSurface(CairoSurface surface, double x, double y);
	...
	private native void setOperator(int op);
	...
	public native void showText(String text);
        ...
        public native void selectFontFace (String family, int slant, int weight);

        public native void textExtents(String label);
